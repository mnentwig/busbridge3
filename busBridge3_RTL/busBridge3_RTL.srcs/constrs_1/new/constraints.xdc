...
# USER2 demo
create_clock -period 33.330 -name JTAGBSCANE2_CLK2 -waveform {0.000 16.660} [get_pins iUser2demo/ifUserDemo/iBSCANE2/DRCK]

set_false_path -from [get_clocks JTAGBSCANE2_CLK2] -to [get_clocks RINGOSC_CLK]
set_false_path -from [get_clocks RINGOSC_CLK] -to [get_clocks JTAGBSCANE2_CLK2]
